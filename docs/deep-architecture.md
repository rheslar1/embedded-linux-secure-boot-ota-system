# Secure Boot and OTA Update System Deep Architecture
...
C++17, C++ Design Patterns, SOLID, U-Boot, Verified boot, FIT images, RAUC/Mender, A/B partition, OTA rollback
