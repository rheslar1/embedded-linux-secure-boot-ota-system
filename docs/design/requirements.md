...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for Secure Boot and OTA Update System. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: Embedded Linux fleet-lifecycle project using U-Boot verified boot, signed FIT images, A/B partitions, and RAUC or Mender rollback-safe updates. | Scenario tests and documentation review. |
